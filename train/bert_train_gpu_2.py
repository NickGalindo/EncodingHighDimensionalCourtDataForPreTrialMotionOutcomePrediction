...
model_path = os.path.join(base_dir, "bertTraining/models/tfigm/extra_2/model")
tok_path = os.path.join(base_dir, "bertTraining/models/tfigm/extra_2/tokenizer")
